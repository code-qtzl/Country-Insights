...
export default function CountryDetails({
	...
	return (
		<div className='relative min-h-screen'>
			<div className='search-gradient-two'>
				<div className='container relative z-20 mx-auto py-16'>
					...
					<div className='bg-neutral-50 dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden p-6'>
						<div className=''>
			...
			<div className='arch-separator-two absolute inset-0 z-10' />
		</div>
	);
}
